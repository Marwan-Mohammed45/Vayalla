      ...
      >
        ...
        >
          ...
          <p className="text-base text-gray-300 leading-relaxed">
           Al-Madina Al-Munawwara is home to the Prophet’s Mosque, where the Prophet Muhammad (peace be upon him) is buried. 
           It is a city of peace and love that witnessed the beginning of Islam. The
            city holds deep emotional and spiritual value for every Muslim.
          </p>
        </motion.div>
      </motion.div>
      ...
      <div className="max-w-5xl mx-auto mb-12">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Discover key information about Al-Madina Al-Munawwara
          </h2>
        </motion.div>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4">
                ...
                <p className="text-white text-sm">
                  {index === 0 ? "30°C in winter and 45°C in summer" : 
                   index === 1 ? "Around eight to ten million" : "85% local, 15% foreign"}
                </p>
              </div>
            </motion.div>
          ))}
