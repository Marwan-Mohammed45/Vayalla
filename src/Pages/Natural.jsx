...
import farasanIslandsImg from "../assets/Farasan-island-1.jpg";
import soudahMountainsImg from "../assets/مشروع-السودة-بالأرقام.jpg";

const attractions = [
  {
    title: "Explore the most prominent natural Attractions",
    description: "",
    image: "",
    isHeader: true
  },
  {
    ...
    description: `The Empty Quarter, or Rub' al Khali, is the largest continuous sand desert in the world, stretching across several countries in the Arabian Peninsula. Its vast dunes and harsh environment embody the spirit of Arabia's natural beauty.`,
    image: rubAlKhaliImg,
    link: "/Rub"
  },
  {
    title: "Farasan Islands",
    description: `Farasan Islands, located in the Red Sea, are known for their rich biodiversity and historical significance. The islands offer a peaceful escape with pristine beaches and fascinating wildlife.`,
    image: farasanIslandsImg,
    link: "/farasan"
  },
  {
    title: "Al-Soudah Mountains",
    description: `Al-Soudah Mountains, located in the Asir region, are known for their breathtaking views, cool climate, and rich flora. It is a popular destination for hiking and nature lovers, offering a serene escape into the mountains.`,
    image: soudahMountainsImg,
    link: "/AlSoudah"
  }
];
