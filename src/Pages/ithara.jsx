...
Ithra is a cultural icon in Dhahran, blending art, knowledge, innovation, and creativity under one roof. It inspires generations through exhibitions, performances, and interactive learning experiences.
      ...
      <div className="max-w-5xl mx-auto mb-12">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Discover key information about Ithra
          </h2>
        </motion.div>
