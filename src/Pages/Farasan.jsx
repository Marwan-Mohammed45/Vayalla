      ...
      >
        ...
        >
          ...
          <p className="text-base text-gray-300 leading-relaxed">
           Farasan Islands, located in the Red Sea, are known for their rich biodiversity and historical significance. The islands offer a peaceful escape with pristine beaches and fascinating wildlife.
          </p>
        </motion.div>
      </motion.div>
      ...
      <div className="max-w-5xl mx-auto mb-12">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Discover key information about Farasan Islands
          </h2>
        </motion.div>
