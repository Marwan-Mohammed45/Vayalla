      ...
      >
        ...
        >
          ...
          <p className="text-base text-gray-300 leading-relaxed">
           Riyadh Zoo is a beloved family attraction featuring a wide variety of animals from around the world. It offers a unique experience to explore wildlife in a natural setting right in the heart of the capital.
          </p>
        </motion.div>
      </motion.div>
      ...
      <div className="max-w-5xl mx-auto mb-12">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Discover key information about Riyadh Zoo
          </h2>
        </motion.div>
