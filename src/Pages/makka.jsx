      ...
      >
        ...
        >
          ...
          <p className="text-base text-gray-300 leading-relaxed">
            Makkah Al-Mukarramah is the holiest place on earth, home to the
            Kaaba, the direction of prayer for Muslims, and the site of Hajj,
            where millions gather from all over the world. It is a spiritual
            center that holds great significance for Muslims globally.
          </p>
        </motion.div>
      </motion.div>
      ...
      <div className="max-w-5xl mx-auto mb-12">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Discover key information about Makkah Al-Mukarramah
          </h2>
        </motion.div>
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4">
                ...
                <p className="text-white text-sm">
                  {index === 0 ? "30°C in winter and 45°C in summer" : 
                   index === 1 ? "Around twenty million" : "60% local, 40% foreign"}
                </p>
              </div>
            </motion.div>
          ))}
