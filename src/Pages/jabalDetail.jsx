      ...
      >
        ...
        >
          ...
          <p className="text-base text-gray-300 leading-relaxed">
           Jabal Uhud is one of the most significant historical landmarks in Madinah, 
           witnessing the famous Battle of Uhud between the Muslims and their enemies. 
           It remains an important site for Muslim visitors, representing sacrifice and bravery.
          </p>
        </motion.div>
      </motion.div>
      ...
      <div className="max-w-5xl mx-auto mb-12">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Discover key information about Jabal Uhud
          </h2>
        </motion.div>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4">
                ...
                <p className="text-white text-sm">
                  {index === 0 ? "25°C in winter and 43°C in summer" : 
                   index === 1 ? "Around one million" : "85% local, 15% foreign"}
                </p>
              </div>
            </motion.div>
          ))}
