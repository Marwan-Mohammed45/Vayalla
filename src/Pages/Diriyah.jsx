...
import locationImage from "../assets/Screenshot4png.png";
...
Ad-Diriyah, particularly At-Turaif District, is a historic gem that served as the birthplace of the first Saudi state. It stands today as a symbol of national pride, showcasing traditional architecture and deep-rooted heritage.          </p>
        </motion.div>
      </motion.div>
      ...
      <div className="max-w-5xl mx-auto mb-12">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Discover key information about Ad-Diriyah (At-Turaif District)
          </h2>
        </motion.div>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4">
                ...
                <p className="text-white text-sm">
                  {index === 0 ? "20°C in winter and 35°C in summer" : 
                   index === 1 ? "Around Six Hundred" : "85% local, 15% foreign"}
                </p>
              </div>
            </motion.div>
          ))}
