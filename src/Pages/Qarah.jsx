...
import masmakImg from "../assets/قلثاث55.jpg";
      ...
      >
        ...
        >
          ...
          <p className="text-base text-gray-300 leading-relaxed">
           Jabal Al-Qarah is a unique mountain in the Eastern Province, famous for its natural caves and cool interior temperature. It's a remarkable tourist destination with stunning natural beauty.
          </p>
        </motion.div>
      </motion.div>
      ...
      <div className="max-w-5xl mx-auto mb-12">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Discover key information about Jabal Al-Qarah
          </h2>
        </motion.div>
