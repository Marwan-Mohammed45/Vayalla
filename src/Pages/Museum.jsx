...
import Museumimg from "../assets/1.jpg";
      ...
      >
        ...
        >
          ...
          <p className="text-base text-gray-300 leading-relaxed">
           The National Museum in Riyadh showcases the rich history and cultural heritage of Saudi Arabia through immersive exhibits and rare artifacts. It is a gateway to understanding the Kingdom's deep-rooted past.
      ...
      <div className="max-w-5xl mx-auto mb-12">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Discover key information about The National Museum
          </h2>
        </motion.div>
