      ...
      >
        ...
        >
          ...
          <p className="text-base text-gray-300 leading-relaxed">
           Al Shallal Theme Park is one of Jeddah's most popular entertainment destinations, offering thrilling rides, ice skating, and family fun by the Red Sea. It's a place where joy and excitement meet.
          </p>
        </motion.div>
      </motion.div>
      ...
      <div className="max-w-5xl mx-auto mb-12">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Discover key information about Al Shallal Theme Park
          </h2>
        </motion.div>
