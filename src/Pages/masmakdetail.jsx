...
import locationImage from "../assets/Screenshot2.png";
import qarahImg from "../assets/1642851691-01.png";
      ...
      >
        ...
        >
          ...
          <p className="text-base text-gray-300 leading-relaxed">
           Al-Masmak Fortress is a historic fort located in Riyadh, symbolizing the 
           unification of the Kingdom of Saudi Arabia. It played a vital role in
            the kingdom’s founding and stands today as a proud cultural landmark.
          </p>
        </motion.div>
      </motion.div>
      ...
      <div className="max-w-5xl mx-auto mb-12">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Discover key information about Al-Masmak Fortress
          </h2>
        </motion.div>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-4">
                ...
                <p className="text-white text-sm">
                  {index === 0 ? "20°C in winter and 40°C in summer" : 
                   index === 1 ? "Around Three Hunderd Thousand" : "85% local, 15% foreign"}
                </p>
              </div>
            </motion.div>
          ))}
