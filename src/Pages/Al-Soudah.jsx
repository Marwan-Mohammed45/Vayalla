    ...
    >
      ...
      >
        ...
        >
          ...
          Al-Soudah Mountains, located in the Asir region, are known for their breathtaking views, cool climate, and rich flora. It is a popular destination for hiking and nature lovers, offering a serene escape into the mountains.
          </p>
        </motion.div>
      </motion.div>
      ...
      <div className="max-w-5xl mx-auto mb-12">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Discover key information about Al-Soudah Mountains
          </h2>
        </motion.div>
