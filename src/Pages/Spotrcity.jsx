      ...
      >
        ...
        >
          ...
          <p className="text-base text-gray-300 leading-relaxed">
           King Abdullah Sports City in Jeddah is a modern sports complex known as "The Jewel," hosting major football matches and events. It reflects the Kingdom's passion for sports and its commitment to world-class infrastructure.
          </p>
        </motion.div>
      </motion.div>
      ...
      <div className="max-w-5xl mx-auto mb-12">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Discover key information about King Abdullah Sports City
          </h2>
        </motion.div>
