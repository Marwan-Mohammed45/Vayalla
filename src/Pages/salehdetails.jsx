...
import locationImage from "../assets/Screenshot1.png";
...
const SalehDetails = () => {
  ...
  return (
    <div 
      ...
      className="text-white px-4 md:px-8 pt-20"
    >
      {/* Main Section */}
      <motion.div 
        ref={section1Ref}
      ...
      >
        ...
        >
          ...
          <p className="text-base text-gray-300 leading-relaxed">
            Madain Saleh is an ancient archaeological site in 
            Saudi Arabia, known for its magnificent rock-cut tombs carved by the Nabataeans. 
            It is a UNESCO World Heritage Site and a testament to ancient Arabian civilization.
          </p>
        </motion.div>
      </motion.div>
      ...
      <div className="max-w-5xl mx-auto mb-12">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            Discover key information about Madain Saleh
          </h2>
        </motion.div>
        ...
        <motion.div
          ...
          className="grid gap-6 md:grid-cols-3 mb-12 justify-center"
        >
          {[
            { img: tempIcon, title: "Average temperature", description: "20°C in winter and 42°C in summer" },
            { img: visitorsIcon, title: "Annual visitors", description: "Around Two Hundred Thousand" },
            { img: populationIcon, title: "Tourist ratio", description: "70% local, 30% foreign" }
          ].map((item, index) => (
            <motion.div
              key={index}
              variants={scaleIn}
              ...
              className="relative h-[350px] w-full max-w-[300px] rounded-[20px] rounded-lg border-2 border-white overflow-hidden shadow-lg group mx-auto"
            >
              <img
                src={item.img}
                alt={item.title}
